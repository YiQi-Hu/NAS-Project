...
if __name__ == '__main__':
    ...
    pre_block = []
    graph_full = [[1, 4, 6, 2, 7], [2, 8], [3, 8], [8], [5, 3, 8], [3, 8], [7, 3], [3]]
    cell_list = [Cell('sep_conv', 16, 5, 'leakyrelu'), Cell('conv', 16, 3, 'relu6'), Cell('sep_conv', 32, 3, 'relu'),
                 Cell('sep_conv', 24, 1, 'relu'), Cell('conv', 32, 5, 'leakyrelu'), Cell('sep_conv', 16, 3, 'relu'),
                 Cell('sep_conv', 24, 1, 'relu'), Cell('sep_conv', 32, 5, 'relu')]
    network1 = NetworkItem(0, graph_full, cell_list, "")
    pre_block.append(network1)
    graph_full = [[1, 4, 5, 2, 3, 6], [2, 3, 6], [3, 6], [6], [3, 6], [3, 6]]
    cell_list = [Cell('conv', 64, 1, 'leakyrelu'), Cell('conv', 48, 1, 'relu'), Cell('conv', 32, 3, 'relu'),
                 Cell('conv', 64, 5, 'relu'), Cell('conv', 32, 5, 'relu'), Cell('conv', 32, 5, 'relu')]
